...
\thusetup{
  ...
  title  = {面向低质量数据与资源受限场景的分割-联邦学习协同优化研究},
  title* = {Research on Collaborative Optimization of Split Federated Learning for Low-Quality Data and Resource-Constrained Scenarios},
