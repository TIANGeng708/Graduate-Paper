...
% 正文部分
\mainmatter
\input{section/sec_background}
\input{section/sec_way}
% \input{data/sec_paper}
% \input{data/sec_sfl}
\input{section/sec_convergence}
% \input{data/sec_convergence.tex}
% \input{data/sec_al.tex}
\input{section/sec_sflct.tex}
\input{section/sec_bpfree.tex}
% \input{data/sec_ex.tex}
\input{section/sec_sum.tex}
...
% 参考文献
\bibliography{ref/tg}  % 参考文献使用 BibTeX 编译
% \printbibliography       % 参考文献使用 BibLaTeX 编译（兼容性不佳，不太推荐）

% 附录
\appendix
% \input{data/fulu}
\input{section/sec_app.tex}
\input{section/sec_app2.tex}
% 致谢
